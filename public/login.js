...
const changeFormSu = () => {
  ...
  leftPanel.className =
    "order-20   absolute w-1/2 h-full  flex flex-col justify-center gap-10  items-center px-10  text-center top-0 transition-all duration-700 ease-in-out translate-x-0 ";
  signUpDiv.className =
    "order-0 translate-x-[100%] w-1/2  transition-all duration-700 ease-in-out";
  panelParent.className =
    "relative top-0   w-1/2 h-full rounded-tr-4xl rounded-br-4xl overflow-hidden transition-all duration-700 ease-in-out rounded-tl-4xl rounded-bl-4xl z-50 translate-x-[-100%] ";
  toggle.className =
    " h-full bg-[var(--btncol)] text-white relative -left-full w-[200%] translate-x-0 transition-all duration-700 ease-in-out translate-x-[50%]";
};
const changeFormSi = () => {
  signInDiv.className =
    "relative  top-0 h-full left-0 w-1/2 z-20  transition-all duration-700 ease-in-out";
  leftPanel.className =
    "absolute  translate-x-[200%] w-1/2 h-full flex flex-col justify-center gap-10  items-center px-10  text-center top-0  transition-all duration-700 ease-in-out  ";
  signUpDiv.className =
    "relative   top-0 h-full left-0 w-1/2 hidden opacity-0  z-10 transition-all duration-700 ease-in-out";
  panelParent.className =
    "relative  top-0  w-1/2 h-full overflow-hidden transition-all duration-700 ease-in-out rounded-tl-4xl rounded-bl-4xl z-50 ";
  toggle.className =
    "h-full bg-[var(--btncol)] text-white relative -left-full w-[200%] translate-x-0 transition-all duration-700 ease-in-out";
};
